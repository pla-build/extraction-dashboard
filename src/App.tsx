        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-xs text-slate-700">
              This estimate is generated by automated extruction and should be reviewed by a qualified estimator.
...
function MethodologyTab({ data }: { data: ProjectData }) {
  ...
  return (
    <div className="space-y-8">
      <div className="rounded-xl border border-slate-800 bg-slate-900/50 p-6">
        <h3 className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-6">Extruction & Estimation Pipeline</h3>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              ...
              It is generated through automated extruction from construction drawings and should be reviewed by a qualified cost consultant
